                    ...
                    <div className="grow min-w-0">
                        <div className="flex items-center flex-wrap gap-2">
                            ...
                            <div className="flex items-center gap-1.5 flex-wrap">
                                ...
                                {item.expense_pot === 'bills' && <span className="px-2 py-0.5 text-xs font-semibold rounded-full bg-purple-100 text-purple-800">Bills Pot</span>}
                                {item.expense_pot === 'groceries' && <span className="px-2 py-0.5 text-xs font-semibold rounded-full bg-green-100 text-green-800">Groceries Pot</span>}
                                ...
                                {item.is_auto_extra && <span className="px-2 py-0.5 text-xs font-semibold rounded-full bg-amber-200 text-amber-900">Auto-balance</span>}
